...
class MapStoreRead<K>(private val map: Map<K, *>) : StoreRead<K> {
    ...
    override fun getString(key: K, defaultValue: String): String = map.getOrDefaultTs(key, defaultValue)
     ...
     */
    private inline fun <reified T, K> Map<K, *>.getOrDefaultTs(key: K, defaultValue: T) = this[key] as? T
            ?: defaultValue
